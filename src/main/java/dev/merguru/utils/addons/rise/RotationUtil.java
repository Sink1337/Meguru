package dev.merguru.utils.addons.rise;


import dev.merguru.utils.addons.vector.Rotation;
...
import static dev.merguru.utils.Utils.mc;
...
public class RotationUtil {
    ...
    public Vector2f calculate(final dev.merguru.utils.addons.vector.Vector3d from, final dev.merguru.utils.addons.vector.Vector3d to) {
        final dev.merguru.utils.addons.vector.Vector3d diff = to.subtract(from);
    ...
    public Vector2f calculate(final Vec3 to, final EnumFacing enumFacing) {
        return calculate(new dev.merguru.utils.addons.vector.Vector3d(to.xCoord, to.yCoord, to.zCoord), enumFacing);
    }

    public Vector2f calculate(final Vec3 to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0, mc.thePlayer.getEyeHeight(), 0), new dev.merguru.utils.addons.vector.Vector3d(to.xCoord, to.yCoord, to.zCoord));
    }

    public Vector2f calculate(final dev.merguru.utils.addons.vector.Vector3d to) {
    ...
    public Vector2f calculate(final dev.merguru.utils.addons.vector.Vector3d position, final EnumFacing enumFacing) {
        ...
        return calculate(new dev.merguru.utils.addons.vector.Vector3d(x, y, z));
    }
