package dev.merguru.utils.spotify;
...
public class SpotifyAPI implements Utils {
    ...
    public final static File CLIENT_ID_DIR = new File(Merguru.DIRECTORY, "SpotifyID.json");
    ...
    public void startConnection() {
        if (!authenticated) {
            try {
                ...
                Merguru.INSTANCE.getExecutorService().submit(() -> {
                    try {
