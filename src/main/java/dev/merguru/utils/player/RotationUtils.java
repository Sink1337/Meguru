...
import dev.merguru.utils.addons.rise.MathConst;
...
import static dev.merguru.utils.addons.rise.RotationUtils.toRotation;
...
public class RotationUtils implements Utils {
    ...
    public static Vector2f calculate(final dev.merguru.utils.addons.vector.Vector3d position, final EnumFacing enumFacing) {
    ...
    public static Vector2f calculate(final dev.merguru.utils.addons.vector.Vector3d to) {
    ...
    public static Vector2f calculate(final dev.merguru.utils.addons.vector.Vector3d from, final dev.merguru.utils.addons.vector.Vector3d to) {
