...
import dev.merguru.module.impl.movement.Speed;
...
public final class TargetStrafe extends Module {
    ...
    public void onMotionEvent(MotionEvent event) {
        KillAura killAura = Merguru.INSTANCE.getModuleCollection().getModule(KillAura.class);
    ...
    public boolean shouldBeActive() {
        ...
        Speed speed = Merguru.INSTANCE.getModuleCollection().getModule(Speed.class);
        Flight flight = Merguru.INSTANCE.getModuleCollection().getModule(Flight.class);
