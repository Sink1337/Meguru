...
import dev.merguru.module.impl.movement.Step;
    ...
    public void onMotionEvent(MotionEvent e) {
        ...
        switch (mode.getMode()) {
            case "Watchdog":
                ...
                if (e.isPre() && watchdogMode.is("Edit") && !Merguru.INSTANCE.isEnabled(Flight.class) && !Step.isStepping && KillAura.attacking) {
                    if (e.isOnGround()) {
                        groundTicks++;
                        if (groundTicks > 2) {
                            stage = !stage;
