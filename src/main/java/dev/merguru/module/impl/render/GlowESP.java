...
public class GlowESP extends Module {
    ...
    private final ColorSetting playerColor = new ColorSetting("Player Color", Merguru.INSTANCE.getClientColor());
    ...
    private final ColorSetting animalColor = new ColorSetting("Animal Color", Merguru.INSTANCE.getAlternateClientColor());
