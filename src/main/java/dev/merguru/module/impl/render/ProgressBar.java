...
public class ProgressBar extends Module {
    ...
    public ProgressBar() {
        ...
        this.progressBarPos = Merguru.INSTANCE.createDrag(this, "progressBar", 450, 300);
    ...
    public void onEnable() {
        longJumpModule = Merguru.INSTANCE.getModuleCollection().getModule(LongJump.class);
        disablerModule = Merguru.INSTANCE.getModuleCollection().getModule(Disabler.class);
