...
import dev.merguru.ui.notifications.Notification;
        ...
        for (Notification notification : NotificationManager.getNotifications()) {
            ...
            switch (mode.getMode()) {
                ...
                case "Exhibition":
                    ...
                    notificationWidth = (int) Math.max(idkFont18.getStringWidth(notification.getTitle()), idkFont14.getStringWidth(notification.getDescription())) + 30;
