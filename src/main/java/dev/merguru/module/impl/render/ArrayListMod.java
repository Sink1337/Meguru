...
public class ArrayListMod extends Module {
    ...
    public void getModulesAndSort() {
        if (modules == null || ModuleCollection.reloadModules) {
            List<Class<? extends Module>> hiddenModules = Merguru.INSTANCE.getModuleCollection().getHiddenModules();
            List<Module> moduleList = Merguru.INSTANCE.getModuleCollection().getModules();
    ...
    public Dragging arraylistDrag = Merguru.INSTANCE.createDrag(this, "arraylist", 2, 1);
