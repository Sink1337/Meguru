...
import dev.merguru.module.impl.render.targethud.AutoDoxTargetHUD;
import dev.merguru.module.impl.render.targethud.RiseTargetHUD;
import dev.merguru.module.impl.render.targethud.TargetHUD;
...
import dev.merguru.utils.objects.GradientColorWheel;
import dev.merguru.utils.objects.PlayerDox;
import dev.merguru.utils.render.ColorUtil;
import dev.merguru.utils.render.ESPUtil;
...
public class TargetHUDMod extends Module {
    ...
    private final Dragging drag = Merguru.INSTANCE.createDrag(this, "targetHud", 300, 300);
    ...
    public void onPreRenderEvent(PreRenderEvent event) {
        ...
        if (killAura == null) {
            killAura = (KillAura) Merguru.INSTANCE.getModuleCollection().get(KillAura.class);
        }
