...
import dev.merguru.event.impl.player.UpdateEvent;
import dev.merguru.module.Category;
import dev.merguru.module.Module;
import dev.merguru.module.impl.misc.EnumFacingUtils;
...
import dev.merguru.utils.BlinkUtils;
import dev.merguru.utils.addons.rise.MovementFix;
import dev.merguru.utils.addons.rise.RayCastUtil;
import dev.merguru.utils.addons.rise.RotationUtil;
...
import dev.merguru.utils.misc.SlotUtil;
import dev.merguru.utils.player.*;
...
import static dev.merguru.utils.misc.MathUtils.getRandom;
...
//
    ...
    public void calculateRotations() {
        final Vector2f rotations = RotationUtil.calculate(new dev.merguru.utils.addons.vector.Vector3d(blockFace.getX(), blockFace.getY(), blockFace.getZ()), enumFacingABC.getEnumFacing());
