...
import dev.merguru.event.impl.player.MoveEvent;
...
import dev.merguru.module.impl.combat.TargetStrafe;
...
import dev.merguru.utils.player.BloxdPhysicsUtils;
...
public final class Speed extends Module {
    ...
    public void onMoveEvent(MoveEvent e) {
        TargetStrafe targetStrafeModule = Merguru.INSTANCE.getModuleCollection().getModule(TargetStrafe.class);
        Disabler disablerModule = Merguru.INSTANCE.getModuleCollection().getModule(Disabler.class);
    ...
    public boolean shouldPreventJumping() {
        ...
        return Merguru.INSTANCE.isEnabled(Speed.class) && MovementUtils.isMoving() && !(mode.is("Watchdog") && watchdogMode.is("Ground")) && !(mode.is("Bloxd") && bloxdMode.is("LowHop")) && !(mode.is("BlocksMC"));
    }
}