...
import dev.merguru.module.impl.combat.*;
import dev.merguru.module.impl.exploit.*;
import dev.merguru.module.impl.misc.*;
import dev.merguru.module.impl.movement.*;
import dev.merguru.module.impl.player.*;
import dev.merguru.module.impl.render.*;
import dev.merguru.module.impl.render.wings.DragonWings;
...
public class ModuleCollection {
    ...
    public static void init() {
        Merguru.INSTANCE.setModuleCollection(new ModuleCollection());
        ...
        Merguru.INSTANCE.getModuleCollection().setModules(modules);
