package dev.merguru.scripting.api;
...
import dev.merguru.scripting.api.bindings.*;
...
public class Script implements Utils {
    ...
    private class CreateDrag implements Function<JSObject, Dragging> {
        ...
        public Dragging apply(JSObject jsObject) {
            ...
            Dragging dragging = Merguru.INSTANCE.createDrag(scriptModule, "script" + description, initialX, initialY);
