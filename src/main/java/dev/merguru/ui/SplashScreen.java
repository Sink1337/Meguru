...
public class SplashScreen implements Utils {
    ...
    private static void drawScreen(float width, float height) {
        ...
        if (versionAnim != null) {
            ...
            float versionWidth = tenacityFont32.getStringWidth(Merguru.VERSION) / 2f;
            ...
            tenacityFont32.drawSmoothString(Merguru.VERSION, versionX, versionY, ColorUtil.applyOpacity(-1, versionAnim.getOutput().floatValue()));
            RenderUtil.scaleEnd();
        }
        ...
        if (progressAnim == null) {
            ...
            Color color1 = ColorUtil.interpolateColorC(Merguru.INSTANCE.getClientColor(), Merguru.INSTANCE.getAlternateClientColor(), progress);
            Color color2 = ColorUtil.interpolateColorC(Merguru.INSTANCE.getAlternateClientColor(), Merguru.INSTANCE.getClientColor(), progress);
