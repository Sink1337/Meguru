package dev.merguru.ui.altmanager.helpers;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import dev.merguru.Merguru;
import dev.merguru.microsoft.MicrosoftLogin;
...
public class AltManagerUtils implements Utils {
    ...
    public static File altsFile = new File(Merguru.DIRECTORY, "Alts.json");
    ...
    public void microsoftLoginAsync(Alt alt, String email, String password) {
        ...
        Multithreading.runAsync(() -> {
            ...
            if (auth != null) {
                ...
                writeAlts();
                Merguru.INSTANCE.getAltManager().currentSessionAlt = finalAlt;
