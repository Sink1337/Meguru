package dev.merguru.ui.altmanager.panels;

import dev.merguru.Merguru;
import dev.merguru.ui.Screen;
import dev.merguru.ui.altmanager.Panel;
...
public class AltPanel extends Panel {
    ...
    public void keyTyped(char typedChar, int keyCode) {
        if (Merguru.INSTANCE.getAltManager().isTyping()) return;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        TextField searchField = Merguru.INSTANCE.getAltManager().searchField;
        boolean filterBanned = Merguru.INSTANCE.getAltManager().filterBanned.isEnabled();
        ...
        public void drawScreen(int mouseX, int mouseY) {
            ...
            switch (alt.getType()) {
                ...
                case "Mojang":
                    ...
                    break;
                case "Cracked":
                    Color red = Merguru.INSTANCE.getSideGui().getRedBadColor();
            ...
            if (Merguru.INSTANCE.getAltManager().currentSessionAlt == alt) {
                Color green = Merguru.INSTANCE.getSideGui().getGreenEnabledColor();
