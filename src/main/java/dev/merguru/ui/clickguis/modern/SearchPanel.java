...
import dev.merguru.utils.objects.PasswordField;
...
public class SearchPanel extends Panel {
    ...
    public void initGui() {
        ...
        modules = Merguru.INSTANCE.getModuleCollection().getModules();
    ...
    public void drawScreen(int mouseX, int mouseY) {
        if (ModernClickGui.searching) {
            ...
            List<Module> possibleMods = Merguru.INSTANCE.getModuleCollection().getModulesThatContainText(text);
