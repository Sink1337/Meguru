...
import dev.merguru.ui.clickguis.dropdown.components.ModuleRect;
...
import static dev.merguru.utils.misc.HoveringUtil.isHovering;
...
public class CategoryPanel implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : Merguru.INSTANCE.getModuleCollection().getModulesInCategory(category).stream().sorted(Comparator.comparing(Module::getName)).collect(Collectors.toList())) {
