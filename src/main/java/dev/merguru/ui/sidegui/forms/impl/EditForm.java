package dev.merguru.ui.sidegui.forms.impl;
...
public class EditForm extends Form {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        updateButton.setClickAction(() -> {
            ...
            Merguru.INSTANCE.getSideGui().displayForm(null);
        });
        ...
        if (error) {
            tenacityFont16.drawCenteredStringWithShadow("Error please fill out the required fields",
                    ...
                    Merguru.INSTANCE.getSideGui().getRedBadColor().getRGB());
        }
        ...
        deleteButton.setColor(Merguru.INSTANCE.getSideGui().getRedBadColor());
    ...
    public void setup(CloudData data, boolean script) {
        ...
        if (script) {
            scriptFiles.setupOptions(Merguru.INSTANCE.getScriptManager().getScriptFileNameList());
        }
