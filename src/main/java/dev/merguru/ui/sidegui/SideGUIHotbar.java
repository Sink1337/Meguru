...
public class SideGUIHotbar implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        tenacityFont18.drawString(Merguru.VERSION, x + 9.5f + tenacityBoldFont32.getStringWidth("Meguru") - 2,
        ...
        if (!searching) {
            ...
            refreshButton.setClickAction(() -> Multithreading.runAsync(() -> Merguru.INSTANCE.getCloudDataManager().refreshData()));

            boolean refreshing = Merguru.INSTANCE.getCloudDataManager().isRefreshing();
            if (refreshing) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (!Merguru.INSTANCE.getCloudDataManager().isRefreshing() && refreshTimer.hasTimeElapsed(12000)) {
