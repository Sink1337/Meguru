package dev.merguru.ui.sidegui.panels.scriptpanel;

import dev.merguru.Merguru;
import dev.merguru.intent.cloud.data.CloudScript;
import dev.merguru.intent.cloud.data.Votes;
import dev.merguru.module.impl.render.HUDMod;
import dev.merguru.scripting.api.Script;
...
public class ScriptPanel extends Panel {
            ...
            button.setClickAction(() -> {
                ...
                switch (button.getName()) {
                    case "Open documentation":
                        ...
                        break;
                    case "Open folder":
                        IOUtils.openFolder(Merguru.INSTANCE.getScriptManager().getScriptDirectory());
                        break;
                }
            });
    ...
    public void refresh() {
        ...
        for (CloudScript cloudScript : Merguru.INSTANCE.getCloudDataManager().getCloudScripts()) {
        ...
        for (Script script : Merguru.INSTANCE.getScriptManager().getScripts()) {
