package dev.merguru.ui.sidegui.panels.searchpanel;
...
import dev.merguru.ui.sidegui.panels.configpanel.CloudConfigRect;
import dev.merguru.ui.sidegui.panels.scriptpanel.CloudScriptRect;
...
public class SearchPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        String search = Merguru.INSTANCE.getSideGui().getHotbar().searchField.getText();
        ...
        if (!searchTypeHold.equals(searchType)) {
            switch (searchType) {
                case "Configs":
                    ...
                    cloudConfigRects.addAll(Merguru.INSTANCE.getSideGui().getConfigPanel().getCloudConfigRects());
                    break;
                case "Scripts":
                    cloudConfigRects.clear();
                    cloudScriptRects.clear();
                    cloudScriptRects.addAll(Merguru.INSTANCE.getSideGui().getScriptPanel().getCloudScriptRects());
                    break;
            }
