...
public class CustomModel extends Module {
    ...
    public static final ResourceLocation amongusModel = new ResourceLocation("meguru/models/amogus.png");
    public static final ResourceLocation rabbitModel = new ResourceLocation("meguru/models/rabbit.png");
