...
public final class Speed extends Module {
    ...
    public void onMoveEvent(MoveEvent e) {
        ...
        Disabler disablerModule = Meguru.INSTANCE.getModuleCollection().getModule(Disabler.class);
    ...
    public boolean shouldPreventJumping() {
        ...
        return Meguru.INSTANCE.isEnabled(Speed.class) && MovementUtils.isMoving() && !(mode.is("Watchdog") && watchdogMode.is("Ground")) && !(mode.is("Bloxd") && bloxdMode.is("LowHop")) && !(mode.is("BlocksMC"));
    }
}