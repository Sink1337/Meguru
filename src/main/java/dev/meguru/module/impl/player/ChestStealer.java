...
public class ChestStealer extends Module {
    ...
    public void onMotionEvent(MotionEvent e) {
        ...
        if (invManager == null) {
            invManager = Meguru.INSTANCE.getModuleCollection().getModule(InvManager.class);
        }

        if (killauraModule == null) {
            killauraModule = Meguru.INSTANCE.getModuleCollection().getModule(KillAura.class);
        }
        if (scaffoldModule == null) {
            scaffoldModule = Meguru.INSTANCE.getModuleCollection().getModule(Scaffold.class);
        }
    ...
    public static boolean canSteal() {
        ...
        if (Meguru.INSTANCE.isEnabled(ChestStealer.class) && mc.currentScreen instanceof GuiChest) {
