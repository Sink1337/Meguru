...
import dev.meguru.module.impl.misc.EnumFacingUtils;
...
import dev.meguru.utils.addons.rise.RayCastUtil;
import dev.meguru.utils.addons.rise.RotationUtil;
...
import dev.meguru.utils.misc.SlotUtil;
import dev.meguru.utils.player.*;
...
import static dev.meguru.utils.misc.MathUtils.getRandom;
...
//
    ...
    public void calculateRotations() {
        final Vector2f rotations = RotationUtil.calculate(new dev.meguru.utils.addons.vector.Vector3d(blockFace.getX(), blockFace.getY(), blockFace.getZ()), enumFacingABC.getEnumFacing());
