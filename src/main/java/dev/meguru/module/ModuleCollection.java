...
import dev.meguru.module.impl.combat.*;
import dev.meguru.module.impl.exploit.*;
import dev.meguru.module.impl.misc.*;
import dev.meguru.module.impl.movement.*;
import dev.meguru.module.impl.player.*;
import dev.meguru.module.impl.render.*;
import dev.meguru.module.impl.render.wings.DragonWings;
...
public class ModuleCollection {
    ...
    public static void init() {
        Meguru.INSTANCE.setModuleCollection(new ModuleCollection());
        ...
        Meguru.INSTANCE.getModuleCollection().setModules(modules);
