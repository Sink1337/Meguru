package dev.meguru.scripting.api;
...
import dev.meguru.scripting.api.bindings.*;
...
public class Script implements Utils {
    ...
    private class CreateDrag implements Function<JSObject, Dragging> {
        ...
        public Dragging apply(JSObject jsObject) {
            ...
            Dragging dragging = Meguru.INSTANCE.createDrag(scriptModule, "script" + description, initialX, initialY);
