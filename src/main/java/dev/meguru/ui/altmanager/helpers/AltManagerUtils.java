package dev.meguru.ui.altmanager.helpers;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import dev.meguru.Meguru;
import dev.meguru.microsoft.MicrosoftLogin;
...
public class AltManagerUtils implements Utils {
    ...
    public static File altsFile = new File(Meguru.DIRECTORY, "Alts.json");
    ...
    public void microsoftLoginAsync(Alt alt, String email, String password) {
        ...
        Multithreading.runAsync(() -> {
            ...
            if (auth != null) {
                ...
                writeAlts();
                Meguru.INSTANCE.getAltManager().currentSessionAlt = finalAlt;
