...
import dev.meguru.ui.altmanager.panels.AltPanel;
import dev.meguru.ui.altmanager.panels.InfoPanel;
import dev.meguru.ui.altmanager.panels.LoginPanel;
import dev.meguru.ui.altmanager.panels.MicrosoftInfoPanel;
...
public class GuiAltManager extends GuiScreen {
    ...
    private static final ResourceLocation successfullysound = new ResourceLocation("meguru/sounds/successfully.wav");
    private static final ResourceLocation failedsound = new ResourceLocation("meguru/sounds/failed.wav");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Meguru.INSTANCE.getModuleCollection().getModule(NotificationsMod.class).render();
        if (Alt.stage != 0) {
