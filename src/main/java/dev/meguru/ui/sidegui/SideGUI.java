...
import dev.meguru.ui.sidegui.forms.impl.SaveForm;
import dev.meguru.ui.sidegui.forms.impl.UploadForm;
import dev.meguru.ui.sidegui.panels.Panel;
import dev.meguru.ui.sidegui.panels.configpanel.ConfigPanel;
import dev.meguru.ui.sidegui.panels.infopanel.InfoPanel;
import dev.meguru.ui.sidegui.panels.scriptpanel.ScriptPanel;
import dev.meguru.ui.sidegui.panels.searchpanel.SearchPanel;
...
public class SideGUI implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ScaledResolution sr = new ScaledResolution(mc);
        HUDMod hudMod = (HUDMod) Meguru.INSTANCE.getModuleCollection().get(HUDMod.class);
