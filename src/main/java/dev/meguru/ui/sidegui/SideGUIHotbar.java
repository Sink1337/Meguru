...
public class SideGUIHotbar implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        tenacityFont18.drawString(Meguru.VERSION, x + 9.5f + tenacityBoldFont32.getStringWidth("Meguru") - 2,
        ...
        if (!searching) {
            ...
            refreshButton.setClickAction(() -> Multithreading.runAsync(() -> Meguru.INSTANCE.getCloudDataManager().refreshData()));

            boolean refreshing = Meguru.INSTANCE.getCloudDataManager().isRefreshing();
            if (refreshing) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (!Meguru.INSTANCE.getCloudDataManager().isRefreshing() && refreshTimer.hasTimeElapsed(12000)) {
