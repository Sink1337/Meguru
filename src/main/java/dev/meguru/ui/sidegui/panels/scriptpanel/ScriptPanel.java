package dev.meguru.ui.sidegui.panels.scriptpanel;

import dev.meguru.Meguru;
import dev.meguru.intent.cloud.data.CloudScript;
import dev.meguru.intent.cloud.data.Votes;
import dev.meguru.module.impl.render.HUDMod;
import dev.meguru.scripting.api.Script;
...
public class ScriptPanel extends Panel {
            ...
            button.setClickAction(() -> {
                ...
                switch (button.getName()) {
                    case "Open documentation":
                        ...
                        break;
                    case "Open folder":
                        IOUtils.openFolder(Meguru.INSTANCE.getScriptManager().getScriptDirectory());
                        break;
                }
            });
    ...
    public void refresh() {
        ...
        for (CloudScript cloudScript : Meguru.INSTANCE.getCloudDataManager().getCloudScripts()) {
        ...
        for (Script script : Meguru.INSTANCE.getScriptManager().getScripts()) {
