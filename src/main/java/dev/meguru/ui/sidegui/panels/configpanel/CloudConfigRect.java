                ...
                switch (iconButton.getIcon()) {
                    ...
                    case FontUtil.SAVE:
                        Multithreading.runAsync(() -> {
                            ...
                            if (Meguru.INSTANCE.getConfigManager().saveConfig(name, saveData)) {
                        ...
                        break;
                    case FontUtil.EDIT:
                        Form form = Meguru.INSTANCE.getSideGui().displayForm("Edit Config");
                        ((EditForm) form).setup(config, false);
                        form.setUploadAction((fileName, updatedDescription) -> {
                            Multithreading.runAsync(() -> {

                                String data = Meguru.INSTANCE.getConfigManager().serialize();
