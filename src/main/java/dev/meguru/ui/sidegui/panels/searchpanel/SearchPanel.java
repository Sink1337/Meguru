package dev.meguru.ui.sidegui.panels.searchpanel;
...
import dev.meguru.ui.sidegui.panels.configpanel.CloudConfigRect;
import dev.meguru.ui.sidegui.panels.scriptpanel.CloudScriptRect;
...
public class SearchPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        String search = Meguru.INSTANCE.getSideGui().getHotbar().searchField.getText();
        ...
        if (!searchTypeHold.equals(searchType)) {
            switch (searchType) {
                case "Configs":
                    ...
                    cloudConfigRects.addAll(Meguru.INSTANCE.getSideGui().getConfigPanel().getCloudConfigRects());
                    break;
                case "Scripts":
                    cloudConfigRects.clear();
                    cloudScriptRects.clear();
                    cloudScriptRects.addAll(Meguru.INSTANCE.getSideGui().getScriptPanel().getCloudScriptRects());
                    break;
            }
