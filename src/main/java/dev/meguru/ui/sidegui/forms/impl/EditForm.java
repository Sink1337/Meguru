package dev.meguru.ui.sidegui.forms.impl;
...
public class EditForm extends Form {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (error) {
            tenacityFont16.drawCenteredStringWithShadow("Error please fill out the required fields",
                    ...
                    Meguru.INSTANCE.getSideGui().getRedBadColor().getRGB());
        }
        ...
        deleteButton.setColor(Meguru.INSTANCE.getSideGui().getRedBadColor());
    ...
    public void setup(CloudData data, boolean script) {
        ...
        if (script) {
            scriptFiles.setupOptions(Meguru.INSTANCE.getScriptManager().getScriptFileNameList());
        }
