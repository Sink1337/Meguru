...
import dev.meguru.ui.GuiEvents;
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof ColorSetting) {
                ...
                GL11.glEnable(GL11.GL_BLEND);
                mc.getTextureManager().bindTexture(new ResourceLocation("meguru/booleanslider1.png"));
                ...
                GL11.glEnable(GL11.GL_BLEND);
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("meguru/colorpicker2.png"));
                ...
                // Hue bar
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("meguru/hue.png"));
