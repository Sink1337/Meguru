...
import dev.meguru.utils.objects.PasswordField;
...
public class SearchPanel extends Panel {
    ...
    public void initGui() {
        ...
        modules = Meguru.INSTANCE.getModuleCollection().getModules();
    ...
    public void drawScreen(int mouseX, int mouseY) {
        if (ModernClickGui.searching) {
            ...
            List<Module> possibleMods = Meguru.INSTANCE.getModuleCollection().getModulesThatContainText(text);
