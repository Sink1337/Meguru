package dev.meguru.ui.clickguis.dropdown.components.settings;

import dev.meguru.module.settings.impl.ColorSetting;
import dev.meguru.module.settings.impl.NumberSetting;
import dev.meguru.ui.clickguis.dropdown.components.SettingComponent;
...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            GLUtil.startBlend();
            RenderUtil.drawImage(new ResourceLocation("meguru/colorpicker2.png"), pickerX, pickerY, 4, 4);
            GLUtil.endBlend();
