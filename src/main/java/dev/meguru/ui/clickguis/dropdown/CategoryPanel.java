...
import dev.meguru.ui.clickguis.dropdown.components.ModuleRect;
...
import static dev.meguru.utils.misc.HoveringUtil.isHovering;
...
public class CategoryPanel implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : Meguru.INSTANCE.getModuleCollection().getModulesInCategory(category).stream().sorted(Comparator.comparing(Module::getName)).collect(Collectors.toList())) {
