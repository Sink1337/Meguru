package dev.meguru.utils.spotify;
...
public class SpotifyAPI implements Utils {
    ...
    public final static File CLIENT_ID_DIR = new File(Meguru.DIRECTORY, "SpotifyID.json");
    ...
    public void startConnection() {
        if (!authenticated) {
            try {
                ...
                Meguru.INSTANCE.getExecutorService().submit(() -> {
                    try {
