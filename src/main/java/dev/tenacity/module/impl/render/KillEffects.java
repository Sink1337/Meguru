...
public class KillEffects extends Module {
    ...
    public static void playSound(String st, float volume) {
        new Thread(() -> {
            try {
                AudioInputStream as = AudioSystem.getAudioInputStream(new BufferedInputStream(mc.getResourceManager().getResource(new ResourceLocation("Tenacity/Sounds/" + st)).getInputStream()));
