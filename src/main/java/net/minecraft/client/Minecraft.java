...
import dev.meguru.event.impl.game.*;
import dev.meguru.event.impl.player.BlockEvent;
import dev.meguru.event.impl.player.BlockPlaceableEvent;
import dev.meguru.event.impl.player.ClickEvent;
import dev.meguru.event.impl.player.ClickEventRight;
import dev.meguru.module.impl.render.ClickGUIMod;
import dev.meguru.module.impl.render.MotionBlur;
import dev.meguru.ui.SplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        Meguru.is0721 = (today.equals(july21));
        ...
        Meguru.INSTANCE.start();

        SplashScreen.continueCount(false);

        this.gameSettings.guiScale = 2;
        if (LocalDate.now().equals(LocalDate.of(LocalDate.now().getYear(), 7, 21))) {
            SoundUtils.playSound(new ResourceLocation("meguru/sounds/goodday.wav"), .9f);
        } else {
            SoundUtils.playSound(new ResourceLocation("meguru/sounds/opening.wav"), .8f);
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Meguru.NAME + " " + Meguru.VERSION);
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            ...
            Meguru.INSTANCE.getEventProtocol().handleEvent(renderTickEvent);
    ...
    public void shutdown() {
        Meguru.INSTANCE.getEventProtocol().handleEvent(new GameCloseEvent());
        this.running = false;
    }
...
//                        this.playerController.attackEntity(this.thePlayer, this.objectMouseOver.entityHit);
    ...
    public void rightClickMouse() {
        Meguru.INSTANCE.getEventProtocol().handleEvent(new ClickEventRight());
    ...
    public void runTick() throws IOException {
        ...
        Meguru.INSTANCE.getEventProtocol().handleEvent(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Meguru.INSTANCE.getEventProtocol().handleEvent(new KeyPressEvent(k));
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                Meguru.INSTANCE.getEventProtocol().handleEvent(blockEvent);
            ...
            Meguru.INSTANCE.getEventProtocol().handleEvent(new BlockPlaceableEvent());
        ...
        try {
            if (Minecraft.getMinecraft().thePlayer != null && Shaders.configAntialiasingLevel == 0) {
                MotionBlur motionBlur = Meguru.INSTANCE.getModuleCollection().getModule(MotionBlur.class);
